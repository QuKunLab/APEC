...
#
clustering.build_accesson('project01/', ngroup=600)
clustering.cluster_byAccesson('project01/', norm='probability')
plot.plot_tsne('project01/')
clustering.cluster_comparison('project01/matrix/filtered_cells.csv',
                              'project01/result/cluster_by_APEC.csv',
                              exclude='UNK')
#
#
...
#
plot.plot_feature('project01/', space='tsne', feature='motif', name='Erg', clip=[0,7])
plot.plot_feature('project01/', space='tsne', feature='motif', name='CTCF', clip=[0,5])
plot.plot_feature('project01/', space='tsne', feature='motif', name='GATA1', clip=[0,25])
#
#
...
#
generate.monocle_trajectory('project01/', around=[6, 25])
